    ...
    public class Periphery
    {
        ...
        public void Start()
        {
            ...
            while (true)
            {
                ...
                var nextQuery = (Query1)_peripheryChannels.Serializer.Deserialize(nextMessage.MetaData, nextMessage.Data);
                ...
                var (meta, data) = _peripheryChannels.Serializer.Serialize(response);
